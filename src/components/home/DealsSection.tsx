  ...
  return (
    <section className="py-16 bg-background">
      <div className="container">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-amber/20">
              <Gift className="w-6 h-6 text-amber-dark" />
            </div>
            <div>
        ...
        {/* XP Banner */}
        <div className="mt-8 p-6 bg-gradient-to-r from-amber/20 to-primary/20 rounded-2xl border border-amber/30">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-xl bg-amber/30 xp-glow">
                <Gift className="w-8 h-8 text-amber-dark" />
              </div>
              <div>
                <h3 className="font-display font-bold text-lg">Earn XP, Get Rewards</h3>
